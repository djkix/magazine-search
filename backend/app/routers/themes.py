...
# « GET /api/themes » a été retiré : il listait les thématiques posées par
# Gemini au niveau du NUMÉRO, via theme_magazines. Cette table n'est plus
# alimentée depuis que la navigation par sujet passe par la taxonomie par
# article, et plus aucun écran n'appelait cet endpoint.
