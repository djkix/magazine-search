...
- **Recherche plein texte** (Meilisearch) avec surlignage des termes, filtres (titre, année, numéro, tags avec sélection des collections associées), un résultat par magazine (avec son nombre d'occurrences du terme recherché, colorée du gris au vert selon son poids relatif) plutôt qu'un par page, classés par pertinence puis par fraîcheur.
